        ...
        $.ajax({
            ...
            success: function(result) {
                if (result  ==="success") {
                    ...
                    $(".contactform").find(".output-message").addClass("success");
                    $(".output-message").html("Your Message has been Sent!");
                    $(".formcontact")[0].reset();
                } else {
                    $(".contactform").find(".form-message").addClass("d-block");
                    $(".contactform").find(".output-message").addClass("d-block error");
                    $(".output-message").text("Error Sending!");
                }
            }
        });
        return false;
